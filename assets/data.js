...
// Mỗi môn có: mô tả, mục tiêu, chương/bài, phạm vi thi, nội dung trọng tâm,
// tài liệu (resources) và trắc nghiệm (quiz).
// Nội dung dưới đây chỉ là KHUNG MẪU — hãy thay bằng đề cương / tài liệu / câu hỏi thật.

// ---- Cách thêm TÀI LIỆU (resources) cho một môn ----
// Mỗi tài liệu là 1 object: { type, title, url }
// type nhận 1 trong các giá trị sau (quyết định icon hiển thị):
//   "drive"       -> file/folder Google Drive
//   "notebooklm"  -> NotebookLM
//   "mindmap"     -> ảnh/link mindmap
//   "pdf"         -> file PDF
//   "doc"         -> file Word/Docs
//   "link"        -> link khác (mặc định)
// url: dán thẳng link chia sẻ (nhớ bật "Anyone with the link" trên Drive/NotebookLM).

// ---- Cách thêm CÂU HỎI TRẮC NGHIỆM (quiz) cho một môn ----
// Mỗi câu là 1 object: { q, options, correct, explain }
// options: mảng 4 đáp án (chuỗi text).
// correct: chỉ số (0,1,2,3) của đáp án đúng trong mảng options.
// explain: giải thích ngắn hiện ra sau khi nộp bài (có thể để chuỗi rỗng "").
...
const COURSES = [
  {
    ...
    resources: [
      { type: "youtube", title: "Playlist bài giảng 1 (YouTube)", url: "https://www.youtube.com/playlist?list=PL02hdzpO3y7gGn60y1ON51u3Av9vJGh3e" },
      { type: "youtube", title: "Playlist bài giảng 2 (YouTube)", url: "https://www.youtube.com/playlist?list=PL02hdzpO3y7hdWiD3a2TPrFme23s9v-OJ" },
      { type: "youtube", title: "Playlist bài giảng 3 (YouTube)", url: "https://www.youtube.com/playlist?list=PL02hdzpO3y7g2sCpFXJWGHibMkBdfvjQR" },
      { type: "drive", title: "Tài liệu (Google Drive)", url: "https://drive.google.com/drive/u/0/folders/1GUHg6Jdc_3PjQ-_xrtRBme3Gh2mlq-Oz" },
    ],
    quiz: [
      {
        q: "Trường phái nào sau đây thuộc nhóm phi chính thống (Nāstika)?",
        options: ["Vedānta", "Nyāya", "Jaina giáo", "Mīmāṃsā"],
        correct: 2,
        explain: "Jaina giáo (cùng Phật giáo, Cārvāka) không công nhận thẩm quyền của Veda nên thuộc nhóm Nāstika.",
      },
      {
        q: "Tiêu chí chính để phân loại Āstika / Nāstika là gì?",
        options: [
          "Có công nhận thẩm quyền của kinh Veda hay không",
          "Ra đời trước hay sau Phật giáo",
          "Có tin vào luân hồi hay không",
          "Có nguồn gốc từ miền Bắc hay Nam Ấn Độ",
        ],
        correct: 0,
        explain: "Āstika = công nhận Veda là thẩm quyền tối cao; Nāstika = không công nhận.",
      },
    ],
  },
  {
    ...
    resources: [
      { type: "notebooklm", title: "NotebookLM — Văn học Pāli I", url: "https://notebook.google.com/notebook/a584eeb0-630b-4387-bd3d-82eed8dd35e1" },
      { type: "youtube", title: "Playlist bài giảng 1 (YouTube)", url: "https://www.youtube.com/playlist?list=PLMDjaKj7S8os" },
      { type: "drive", title: "Tài liệu Drive 1", url: "https://drive.google.com/drive/folders/1nBgC6IjjlBFzQwxE0XFWEpxpbQb6iGZo" },
      { type: "youtube", title: "Playlist bài giảng 2 (YouTube)", url: "https://www.youtube.com/playlist?list=PL02hdzpO3y7hYwud8rSCW2C6MCU9hflPm" },
      { type: "youtube", title: "Playlist bài giảng 3 (YouTube)", url: "https://www.youtube.com/playlist?list=PL02hdzpO3y7gJ_1YPmH19q1juhrqkafxG" },
      { type: "drive", title: "Tài liệu Drive 2", url: "https://drive.google.com/drive/folders/1rcry3E2k-2nPgTAheGCq5RNNh3CChb53" },
    ],
    quiz: [
      {
        q: "Danh từ giống đực nhóm -a ở cách chủ cách (Nom.) số ít có đuôi gì?",
        options: ["-a", "-o", "-aṃ", "-ā"],
        correct: 1,
        explain: "VD: buddha → buddho (chủ cách số ít, giống đực nhóm -a).",
      },
    ],
  },
  {
    ...
    resources: [
      { type: "drive", title: "Tài liệu kinh văn (Google Drive)", url: "https://drive.google.com/YOUR-LINK-3" },
      { type: "notebooklm", title: "NotebookLM — Kinh Trường A-hàm", url: "https://notebooklm.google.com/YOUR-LINK" },
      { type: "mindmap", title: "Mindmap cấu trúc Trường A-hàm", url: "https://drive.google.com/YOUR-MINDMAP-LINK" },
    ],
    quiz: [
      {
        q: "Trường A-hàm (Hán tạng) tương đương với bộ kinh nào trong Pāli tạng?",
        options: ["Majjhima Nikāya", "Saṃyutta Nikāya", "Dīgha Nikāya", "Aṅguttara Nikāya"],
        correct: 2,
        explain: "Trường A-hàm ứng với Dīgha Nikāya — nhóm các bài kinh dài.",
      },
    ],
  },
  {
    ...
    resources: [
      { type: "drive", title: "Tài liệu (Google Drive)", url: "https://drive.google.com/drive/folders/1WOHlgPv5ux9OC5UKufset2HxelW_G-gM?usp=sharing" },
      { type: "youtube", title: "Playlist bài giảng (YouTube)", url: "https://www.youtube.com/playlist?list=PLd6lPh8VJ98Q" },
    ],
    quiz: [
      {
        q: "Sandhi trong ngữ pháp Pāli là hiện tượng gì?",
        options: ["Chia động từ theo ngôi", "Biến âm khi hai âm tiếp giáp nhau", "Ghép hai danh từ thành một", "Đảo trật tự từ trong câu"],
        correct: 1,
        explain: "Sandhi là hiện tượng biến đổi ngữ âm xảy ra ở ranh giới hai từ/âm tiết liền kề.",
      },
    ],
  },
  {
    ...
    resources: [
      { type: "drive", title: "Tài liệu Drive 1", url: "https://drive.google.com/drive/folders/1vaqw5FtoNTiF1H2Rub7z_pMlSLTdNrlq" },
      { type: "drive", title: "Tài liệu Drive 2", url: "https://drive.google.com/drive/folders/1qZxy884BHlZXSmAKXk5x72Xpom1ZbHex" },
      { type: "youtube", title: "Playlist bài giảng (YouTube)", url: "https://www.youtube.com/playlist?list=PLIPKSFeaiubI" },
      { type: "notebooklm", title: "NotebookLM — Lịch sử PG Trung Quốc", url: "https://notebook.google.com/notebook/4f616e63-1509-4672-a0d4-c3b858450c3e" },
    ],
    quiz: [
      {
        q: "Tông phái nào lấy pháp môn niệm Phật làm trọng tâm tu tập?",
        options: ["Thiền tông", "Hoa Nghiêm tông", "Tịnh Độ tông", "Thiên Thai tông"],
        correct: 2,
        explain: "Tịnh Độ tông chủ trương niệm danh hiệu Phật A-di-đà để cầu vãng sinh Tây phương Cực lạc.",
      },
    ],
  },
];
