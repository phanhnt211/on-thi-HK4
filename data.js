...
const COURSES = [
  {
    ...
    resources: [
      { type: "drive", title: "Slide bài giảng (Google Drive)", url: "https://drive.google.com/YOUR-LINK-1" },
      { type: "notebooklm", title: "NotebookLM — Triết học Ấn Độ", url: "https://notebooklm.google.com/YOUR-LINK" },
      { type: "mindmap", title: "Mindmap: Āstika vs Nāstika", url: "https://drive.google.com/YOUR-MINDMAP-LINK" },
    ],
    quiz: [
      {
  ...
  },
  {
    ...
    resources: [
      { type: "drive", title: "Bảng biến cách (Google Drive)", url: "https://drive.google.com/YOUR-LINK-2" },
      { type: "notebooklm", title: "NotebookLM — Pāli I", url: "https://notebooklm.google.com/YOUR-LINK" },
    ],
    quiz: [
      {
  ...
  },
  {
    ...
    resources: [{ type: "drive", title: "Bài tập ngữ pháp (Google Drive)", url: "https://drive.google.com/YOUR-LINK-4" }],
    quiz: [
      {
  ...
  },
  {
    ...
    resources: [
      { type: "drive", title: "Tài liệu lịch sử (Google Drive)", url: "https://drive.google.com/YOUR-LINK-5" },
      { type: "notebooklm", title: "NotebookLM — Lịch sử PG Trung Quốc", url: "https://notebooklm.google.com/YOUR-LINK" },
      { type: "mindmap", title: "Mindmap các tông phái", url: "https://drive.google.com/YOUR-MINDMAP-LINK" },
    ],
    quiz: [
      {
